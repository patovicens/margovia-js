...
If you use `wrapOpenAI`, `wrapAnthropic`, or `margovia.track(...)`, the SDK handles this lifecycle for you. If you use `startRun(...)` manually, always call `run.complete(...)` or `run.fail(...)`.
