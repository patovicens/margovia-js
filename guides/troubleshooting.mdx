...
- Your provider call actually executes through the tracked adapter, wrapper, or provider helper
...
Tracked adapters, wrapped provider calls, provider helpers, and `margovia.track(...)` complete or fail runs automatically.
